...
execute if entity @s[advancements={reincarnation-origins:deathsworn/zombie=false},nbt={SelectedItem:{tag:{mob:"Drowned"}}}] run title @s title {"translate":"reincarnation-origins.deathsworn.zombie_requirement","color":"red","bold":true}
...
execute if entity @s[advancements={reincarnation-origins:deathsworn/zombie=false},nbt={SelectedItem:{tag:{mob:"Husk"}}}] run title @s title {"translate":"reincarnation-origins.deathsworn.zombie_requirement","color":"red","bold":true}
...
execute if entity @s[advancements={reincarnation-origins:deathsworn/zombie=false},nbt={SelectedItem:{tag:{mob:"Zombified_Piglin"}}}] run title @s title {"translate":"reincarnation-origins.deathsworn.zombie_requirement","color":"red","bold":true}
...
execute if entity @s[advancements={reincarnation-origins:deathsworn/zombified_piglin=false},nbt={SelectedItem:{tag:{mob:"Piglin_Brute"}}}] run title @s title {"translate":"reincarnation-origins.deathsworn.zombified_piglin_requirement","color":"red","bold":true}
...
execute if entity @s[advancements={reincarnation-origins:deathsworn/skeleton=false},nbt={SelectedItem:{tag:{mob:"Stray"}}}] run title @s title {"translate":"reincarnation-origins.deathsworn.skeleton_requirement","color":"red","bold":true}
...
execute if entity @s[advancements={reincarnation-origins:deathsworn/skeleton=false},nbt={SelectedItem:{tag:{mob:"Wither_Skeleton"}}}] run title @s title {"translate":"reincarnation-origins.deathsworn.skeleton_requirement","color":"red","bold":true}
