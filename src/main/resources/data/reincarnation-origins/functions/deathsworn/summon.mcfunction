...
execute if entity @s[advancements={reincarnation-origins:deathsworn/zombie=false},nbt={SelectedItem:{tag:{mob:"Drowned"}}}] run w @s "You must first start the Path of Flesh by summoning a Zombie!"
...
execute if entity @s[advancements={reincarnation-origins:deathsworn/zombie=false},nbt={SelectedItem:{tag:{mob:"Husk"}}}] run w @s "You must first start the Path of Flesh by summoning a Zombie!"

# Zombified Piglin
execute if entity @s[advancements={reincarnation-origins:deathsworn/zombie=true},nbt={SelectedItem:{tag:{mob:"Zombified_Piglin"}}}] run function reincarnation-origins:deathsworn/summons/husk
execute if entity @s[advancements={reincarnation-origins:deathsworn/zombie=false},nbt={SelectedItem:{tag:{mob:"Zombified_Piglin"}}}] run w @s "You must first start the Path of Flesh by summoning a Zombie!"
...
execute if entity @s[advancements={reincarnation-origins:deathsworn/zombified_piglin=false},nbt={SelectedItem:{tag:{mob:"Piglin_Brute"}}}] run w @s "Learn how to recreate this creature by recreating a Zombified Piglin."
...
execute if entity @s[advancements={reincarnation-origins:deathsworn/skeleton=false},nbt={SelectedItem:{tag:{mob:"Stray"}}}] run w @s "You must first summon a Skeleton to learn how to create a Stray"
