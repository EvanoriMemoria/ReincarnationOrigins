...
summon minecraft:skeleton_horse ~ ~ ~1 {CustomName:'[{"text":"Nightmare Steed"}]',Tags:["nightmareSteed","temp"],Tame:1,Invulnerable:1,SaddleItem:{id:"saddle",Count:1},Attributes:[{Name:"generic.movement_speed",Base:0.4d}],DeathLootTable:"minecraft:empty"}
